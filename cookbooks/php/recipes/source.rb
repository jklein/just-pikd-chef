...
pkgs = value_for_platform_family(
  ...
  %w{ debian ubuntu } => %w{ bison libbz2-dev libc-client2007e-dev libcurl4-gnutls-dev libfreetype6-dev libgmp3-dev libgmp-dev libjpeg62-dev libkrb5-dev libmcrypt-dev libpng12-dev libssl-dev libt1-dev re2c libreadline-dev },
